...
#ifndef PUSHKIN_HTTP_SERVER_DETAIL_PATH_MATCHER_HPP_
#define PUSHKIN_HTTP_SERVER_DETAIL_PATH_MATCHER_HPP_
...
public:
	typedef ::tip::iri::path::const_iterator path_iterator;
...
#endif /* PUSHKIN_HTTP_SERVER_DETAIL_PATH_MATCHER_HPP_ */
