...
#ifndef PUSHKIN_HTTP_SERVER_GRAMMAR_LOCALE_NAME_HPP_
#define PUSHKIN_HTTP_SERVER_GRAMMAR_LOCALE_NAME_HPP_

#include <pushkin/http/server/locale_name.hpp>
...
#endif /* PUSHKIN_HTTP_SERVER_GRAMMAR_LOCALE_NAME_HPP_ */
