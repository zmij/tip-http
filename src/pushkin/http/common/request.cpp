...
host_name(std::string const& s)
{
    ...
    using iauthority_grammar = ::tip::iri::grammar::parse::iauthority_grammar<string_iterator>;
...
request::request(request_method m,
        path_type const& p, query_type const& q, fragment_type const& f,
...
request::parse_iri(std::string const& iri_str, iri_type& iri)
{
    namespace qi = boost::spirit::qi;
    using string_iterator = std::string::const_iterator;
    using iri_grammar = ::tip::iri::grammar::parse::iri_grammar< string_iterator,
