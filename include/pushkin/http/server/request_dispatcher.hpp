...
#ifndef PUSHKIN_HTTP_SERVER_REQUEST_DISPATCHER_HPP_
#define PUSHKIN_HTTP_SERVER_REQUEST_DISPATCHER_HPP_
...
class request_dispatcher: public request_handler {
public:
...
#endif /* PUSHKIN_HTTP_SERVER_REQUEST_DISPATCHER_HPP_ */
