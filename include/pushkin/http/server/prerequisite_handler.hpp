...
#ifndef PUSHKIN_HTTP_SERVER_PREREQUISITE_HANDLER_HPP_
#define PUSHKIN_HTTP_SERVER_PREREQUISITE_HANDLER_HPP_
...
struct prerequisite_builder< ::tip::util::indexes_tuple< Indexes ... >, T ... >
		: prerequisite< Indexes, T > ... {
	typedef prerequisite_builder<
			::tip::util::indexes_tuple< Indexes ... >, T ... > builder_type;
	enum {
	...
	template < size_t N >
	prerequisite< N, typename ::tip::util::nth_type< 0, T ... >::type > const&
	nth() const
	{
		using nth_prerequisite = prerequisite< N, typename ::tip::util::nth_type< 0, T ... >::type >;
...
class prerequisites :
		public detail::prerequisite_builder<
			typename ::tip::util::index_builder< sizeof ... (Prerequisite) >::type,
			Prerequisite ...  > {
public:
...
#endif /* PUSHKIN_HTTP_SERVER_PREREQUISITE_HANDLER_HPP_ */
