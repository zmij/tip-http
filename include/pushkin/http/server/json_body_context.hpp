...
#ifndef PUSHKIN_HTTP_SERVER_JSON_BODY_CONTEXT_HPP_
#define PUSHKIN_HTTP_SERVER_JSON_BODY_CONTEXT_HPP_
...
struct json_error_sender {
    static void
    send_error(::psst::http::server::reply r, ::psst::http::server::error const& e)
    {
        e.log_error();
...
#endif /* PUSHKIN_HTTP_SERVER_JSON_BODY_CONTEXT_HPP_ */
