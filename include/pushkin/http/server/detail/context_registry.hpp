...
#ifndef PUSHKIN_HTTP_SERVER_DETAIL_CONTEXT_REGISTRY_HPP_
#define PUSHKIN_HTTP_SERVER_DETAIL_CONTEXT_REGISTRY_HPP_
...
private:
	...
	create( reply const& );
private:
	friend class ::psst::http::server::reply;
	void
...
#include <pushkin/http/server/detail/context_registry.inl>

#endif /* PUSHKIN_HTTP_SERVER_DETAIL_CONTEXT_REGISTRY_HPP_ */
