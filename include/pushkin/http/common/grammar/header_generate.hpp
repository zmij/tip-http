...
#ifndef PUSHKIN_HTTP_COMMON_GRAMMAR_HEADER_GENERATE_HPP_
#define PUSHKIN_HTTP_COMMON_GRAMMAR_HEADER_GENERATE_HPP_
...
#endif /* PUSHKIN_HTTP_COMMON_GRAMMAR_HEADER_GENERATE_HPP_ */
