...
#ifndef PUSHKIN_HTTP_COMMON_GRAMMAR_COOKIE_GENERATE_HPP_
#define PUSHKIN_HTTP_COMMON_GRAMMAR_COOKIE_GENERATE_HPP_
...
struct set_cookie_grammar :
	...
	::tip::iri::grammar::gen::ipath_grammar< OutputIterator > path;
};
...
#endif /* PUSHKIN_HTTP_COMMON_GRAMMAR_COOKIE_GENERATE_HPP_ */
