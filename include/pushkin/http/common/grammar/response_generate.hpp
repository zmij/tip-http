...
#ifndef PUSHKIN_HTTP_COMMON_GRAMMAR_RESPONSE_GENERATE_HPP_
#define PUSHKIN_HTTP_COMMON_GRAMMAR_RESPONSE_GENERATE_HPP_
...
#endif /* PUSHKIN_HTTP_COMMON_GRAMMAR_RESPONSE_GENERATE_HPP_ */
