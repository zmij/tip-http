...
#ifndef PUSHKIN_HTTP_COMMON_GRAMMAR_HEADER_PARSE_HPP_
#define PUSHKIN_HTTP_COMMON_GRAMMAR_HEADER_PARSE_HPP_
...
struct header_name_grammar :
    ...
    header_name_grammar() : header_name_grammar::base_type(field_name)
    {
        ...
        field_name %= no_case[ known_header ] | +(alnum | char_("-"));
    }
...
#endif /* PUSHKIN_HTTP_COMMON_GRAMMAR_HEADER_PARSE_HPP_ */
