...
#ifndef PUSHKIN_HTTP_COMMON_GRAMMAR_REQUEST_GENERATE_HPP_
#define PUSHKIN_HTTP_COMMON_GRAMMAR_REQUEST_GENERATE_HPP_
...
psst::http::request,
(psst::http::request_method, psst::http::request_method, obj.method, /**/)
(tip::iri::path&, tip::iri::path const&, obj.path, /**/)
(psst::http::request::query_type&, psst::http::request::query_type const&, obj.query, /**/)
(tip::iri::fragment&, tip::iri::fragment const&, obj.fragment, /**/)
(psst::http::request::version_type&, psst::http::request::version_type const&, obj.version, /**/)
(psst::http::headers&, psst::http::headers const&, obj.headers_, /**/)
)
...
struct query_param_grammar :
	...
	query_param_grammar() : query_param_grammar::base_type(query_param)
	{
		...
		tip::iri::grammar::gen::is_hex_escaped ihe;
...
struct request_grammar :
	...
	::tip::iri::grammar::gen::ipath_grammar< OutputIterator > ipath;
	query_grammar< OutputIterator > query_format;
	boost::spirit::karma::rule< OutputIterator, request::query_type()> query;
	::tip::iri::grammar::gen::ifragment_grammar< OutputIterator > fragment_format;
	boost::spirit::karma::rule< OutputIterator, ::tip::iri::fragment()> fragment;
...
#endif /* PUSHKIN_HTTP_COMMON_GRAMMAR_REQUEST_GENERATE_HPP_ */
