...
#ifndef PUSHKIN_HTTP_COMMON_GRAMMAR_REQUEST_PARSE_HPP_
#define PUSHKIN_HTTP_COMMON_GRAMMAR_REQUEST_PARSE_HPP_
...
struct request_first_line_grammar :
    ...
    ::tip::iri::grammar::parse::ipath_absolute_grammar< InputIterator > ipath;
    query_grammar< InputIterator > query;
    ::tip::iri::grammar::parse::ifragment_grammar< InputIterator > fragment;
...
#endif /* PUSHKIN_HTTP_COMMON_GRAMMAR_REQUEST_PARSE_HPP_ */
