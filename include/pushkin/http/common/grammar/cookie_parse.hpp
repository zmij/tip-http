...
#ifndef PUSHKIN_HTTP_COMMON_GRAMMAR_COOKIE_PARSE_HPP_
#define PUSHKIN_HTTP_COMMON_GRAMMAR_COOKIE_PARSE_HPP_
...
#include <pushkin/http/common/grammar/datetime_parse.hpp>
...
struct set_cookie_grammar :
	...
	boost::spirit::qi::rule< InputIterator, ::tip::iri::host()> domain_av;
	boost::spirit::qi::rule< InputIterator, ::tip::iri::path()> path_av;
...
#endif /* PUSHKIN_HTTP_COMMON_GRAMMAR_COOKIE_PARSE_HPP_ */
